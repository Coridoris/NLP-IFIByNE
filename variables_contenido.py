...
eliminando_outliers = True #en la tesis los eliminamod
...
for ind, tema in enumerate(temas):
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Texto/{tema}_crudo_y_lemm_usando_stanza_.csv' #path donde guardaste tus textos lemm y crudos
...
for i in tqdm(range(len(temas))):
    ...
    #else:
       # df_contenido.to_csv(f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Variables contenido/variables_contenido_{temas[i]}.csv', index=False)    #path donde queres guardar
