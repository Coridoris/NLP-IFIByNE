...
entrevista = 'Segunda' #iria control

ent = 'segunda' #iria control

nro_sujetos = 65 #el número de sujetos que tenes
...
for i, tema in tqdm(enumerate(temas)):
    ...
    path_autopercepcion = f'C:/Users/Usuario/Desktop/Cori/Tesis/Encuestas/Postentrevista/{entrevista}_entrevista/Post_entrevista_{tema}_{ent}.csv' #aca tenes que poner la locación de los csv que armaste a mano
    ...
    df_autopercepcion.to_csv(f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Variables autopercepcion/variables_autopercepcion_{tema}.csv', index=False)  #aca tenes que poner dónde queres que te guarde  
