...
Hay que leer el README de ruben antes para ver que no cambie nada.
...
temas = ["campeones_del_mundo"] #adaptar tenes que ir cambiandolo

key = "blabla" #adaptar tu key

for i, tema in tqdm(enumerate(temas)):
    

    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Texto/{tema}_crudo_y_lemm_usando_stanza_.csv' #adaptar donde tenes los textos.
    ...
    #df_textos.to_csv(f'C:/Users/Usuario/Desktop/Cori/Tesis/Primera_entrevista/Clasificacion_episodico_semantico/textos_limpios_{tema}.csv')    #adaptar donde quieras guardar los textos en español para poner en ruben. Guardar esto no es necesario, en su momento lo hice porque queria chequear si la clasificacion era parecida en ingles que en español
...
df_textos.to_csv(f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Clasificacion_episodico_semantico/clean_text_{tema}.csv') #adaptar donde quieras guardar los textos en ingles

#%% si se traba mucho aca podes ir haciendo uno por uno
...
#%% aca en algun momento estaba cambiando cosas a mano porque se trababa
