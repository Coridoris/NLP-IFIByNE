...
def csv_coherence_evolution(tema):
    ...
    y asi
    '''
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Texto/{tema}_crudo_y_lemm_usando_stanza_.csv' #adaptar donde guardaste los textos lemm y crudos
    ...
    df_textos.to_csv(f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/{tema}_coherencia_evolucion.csv', index = False) #adaptar donde queres que guarde la coherencia
...
for j in tqdm(range(len(temas))):
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Texto/{temas[j]}_crudo_y_lemm_usando_stanza_.csv' #adaptar es donde tenes los textos crudos y lem
...
#después pensé en el mínimo, pero a veces no llega ni a 5. Lo que se me ocurrió es tomar 2 de cada tema
...
df.to_csv(f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/coherencia_evolucion_random.csv') #adaptar aca tenes que poner donde queres que te guarde el modelo nulo
...
path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/coherencia_evolucion_random.csv' #adaptar donde guardaste el modelo nulo
...
for i in tqdm(range(len(temas))):
    tema =  temas[i]
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/{tema}_coherencia_evolucion.csv' #adaptar donde guardaste la coherencia (en la función de arriba)
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/{tema}_coherencia_evolucion_norm.csv' #adaptar donde quieras guardar la coherencia norm
    
    df_coherence_evolution.to_csv(path)

#%% SI SOLO QUERES GUARDAR COHERENCIA CORRER--> recomiendo no usar

for tema in temas:
    
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/{tema}_coherencia_evolucion_norm.csv' #adaptar donde guardaste la coherencia norm
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Coherencia/{tema}_coherencia_evolucion_norm_ELcsv.csv' #adaptar donde quieras guardar las 3 vars de coherencia que se usan
...
def grafo_text_sujeto(sujeto, tema, entrevista, lemm = 'False'):
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Texto/{tema}_crudo_y_lemm_usando_stanza_.csv' #adaptar donde guardaste transcripciones lemm y crudas
    ...
    if texto != np.nan:
        ...
        return np.nan
#%% si queres ver grafos, sino no correr
...
def LSC_text_sujeto(sujeto, tema, entrevista, lemm = 'False',  close = 'True', todas = False):
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Texto/{tema}_crudo_y_lemm_usando_stanza_.csv' #adaptar transcripciones lemm y crudas
...
#%% CORRER SOLO SI QUERES GUARDAR LA DE REDES APARTE --> recomiendo no
...
for j, tema in tqdm(enumerate(temas)):
    ...
    path = f'C:/Users/Usuario/Desktop/Cori/Tesis/{entrevista}_entrevista/Red/Atributos/df_red_norm_{tema}.csv' #adaptar a donde quieras guardar esto
...
for j, tema in tqdm(enumerate(temas)):
    ...
    df_estructurales.to_csv(f'C:blabla/{entrevista}_entrevista/Variables estructurales/variables_estructurales_{tema}.csv', index=False)     #adaptar donde quieras guardar las estructurales
